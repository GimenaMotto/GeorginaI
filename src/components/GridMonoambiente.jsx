...
import Monoambiente from "./Monoambiente";
    ...
    return (
        imagesLoaded && (
            <div style={{ display: "flex", justifyContent: "center", width: "100%" }}>
                <div style={{ width: "100%", marginTop: "20px", marginBottom: "40px", marginLeft: isLargeScreen || isMediumScreen ? "90px" : "none" }}>
                    <Monoambiente />
                    <Grid container spacing={2} style={{ maxWidth: '90%', marginLeft: isLargeScreen || isMediumScreen ? "90px" : "none" }}>
                        {/* Primera imagen */}
                        <Grid item xs={12} sm={6} md={3}>
                            <Link to="/ruta-de-la-primera-imagen">
                                <div
                                    style={{
                                        position: "relative",
                                        width: "75%",
