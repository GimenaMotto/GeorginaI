...
import GridMonoambiente from "./GridMonoambiente";
...
const Monoambiente = () => {
    ...
    return (
        imagesLoaded && (
            <div style={{ margin: '20px auto', maxWidth: '100%', overflowX: 'hidden', marginLeft: isLargeScreen || isMediumScreen ? "110px" : "0px" }}>
                    ...
                    <Card variant="outlined" style={{ maxWidth: '85%', margin: '0 auto', backgroundColor: '#f0ede6', border: 'none' }}>
                        ...
                        <CardContent style={{ maxWidth: '100%', overflowY: 'auto' }}>
                            ...
                            <div id="currentImage" style={{ marginTop: '10px', overflow: 'hidden', width: '90%', height: 'auto' }}>
                                {/* Imagen actual */}
                                {currentIndex === 0 && <img src={image1} alt="Image 1" style={{ maxWidth: '60%', height: 'auto', objectFit: 'cover' }} />}
                                {currentIndex === 1 && <img src={image2} alt="Image 2" style={{ maxWidth: '60%', height: 'auto', objectFit: 'cover' }} />}
                                {currentIndex === 2 && <img src={image3} alt="Image 3" style={{ maxWidth: '60%', height: 'auto', objectFit: 'cover' }} />}
                                {currentIndex === 3 && <img src={image4} alt="Image 4" style={{ maxWidth: '60%', height: 'auto', objectFit: 'cover' }} />}
                            </div>
